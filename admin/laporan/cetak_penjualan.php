...
$pdf->SetLineWidth(0);
$pdf->ln(1);
$pdf->Cell(23,0.7,"Data Penjulan Pertanggal  : ".$tgl1. " S/d ". $tgl2 ,0,0,'C');   
...
$query=mysql_query("select * from tb_beli where tanggal BETWEEN '$tgl1' AND '$tgl2' ORDER BY id DESC ");
 ...
 while($lihat=mysql_fetch_array($query)){
	...
	$x=mysql_query("select sum(total_harga) as total from tb_beli where tanggal BETWEEN '$tgl1' AND '$tgl2'");
...
$pdf->Output("laporan_data_penjulan.pdf","I");

...
<form class="form-inline" method="POST" action="laporan/cetak_hutang_tgl.php">
  ...
  <button type="submit" class="btn btn-danger mt-2 mr-2"><i class="fa fa-print" aria-hidden="true"></i> Cetak per tanggal </button>
   
</form>
<a href="laporan/cetak_hutangall.php" target="_blank" class="btn btn-warning mt-2"><i class="fa fa-print" aria-hidden="true"></i> Cetak semua data </a>
              ...
              <div class="table-responsive">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0" style="font-size: 12.3px;">
                  ...
                  <tbody>
                    ...
                    include "../koneksi.php";
                    $result = mysql_query("SELECT nama,alamat,tanggal_pembelian,tanggal_pelunasan,harga_jual, uang_muka, sisa_pembayaran, id FROM tb_hutang group by nama ORDER BY id DESC") or die(mysql_error());
                    $no = 1;
                    $na = 0;
                    while ($data = mysql_fetch_array($result)) {
                   ...
                   ?>
                    <tr>
                      ...
                      <?php 
                        $nama = $data['nama'];
                        $rows = mysql_query("SELECT * FROM tb_hutang WhERE nama = '$nama'");
                        $aku = mysql_num_rows($rows);
                      ...
                      <td>
                         <a href="detail_hutang.php?nama=<?=$data['nama'];?>"class="btn btn-outline-success"> Lihat </a>
                        <a href="hapus_hutang.php?id=<?=$data['id'];?>" onclick="return confirm('Apakah kamu yakin igin menghapus?')" class="btn btn-outline-danger"> Hapus </a>
